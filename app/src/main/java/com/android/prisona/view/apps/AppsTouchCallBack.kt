...
class AppsTouchCallBack(private val onMoveBlock: (from: Int, to: Int) -> Unit) :
    ...
    override fun getMovementFlags(
        ...
        return try {
            ...
            Logger.e(TAG, "Error getting movement flags: ${e.message}")
    ...
    override fun onMove(
        ...
        return try {
            ...
            if (fromPosition == RecyclerView.NO_POSITION || toPosition == RecyclerView.NO_POSITION) {
                Logger.w(TAG, "Invalid positions: from=$fromPosition, to=$toPosition")
                false
            ...
            Logger.e(TAG, "Error in onMove: ${e.message}")
            false
        }
    }
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        try {
            ...
            Logger.e(TAG, "Error in onSelectedChanged: ${e.message}")
        }
    }
    ...
    override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
        try {
            ...
            Logger.e(TAG, "Error in clearView: ${e.message}")
        }
    }
    ...
    override fun canDropOver(
        ...
        return try {
            ...
            Logger.e(TAG, "Error in canDropOver: ${e.message}")
            false
        }
    }
}