...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return PPackageManager.get().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return PPackageManager.get().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
