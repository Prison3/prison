...
public class BPackage implements Parcelable {
    ...
    public PPackageSettings mExtras;
    ...
    public BPackage(PackageParser.Package aPackage) {
        ...
        // this.mExtras = new PPackageSettings((PackageSetting) aPackage.mExtras);
...
//        this.mExtras = in.readParcelable(PPackageSettings.class.getClassLoader());
