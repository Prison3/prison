...
import com.android.prison.entity.InstallResult;
import com.android.prison.entity.InstalledPackage;
import com.android.prison.utils.AbiUtils;
import com.android.prison.utils.FileUtils;
import com.android.prison.utils.PackageParserCompat;

import static android.content.pm.PackageManager.MATCH_DIRECT_BOOT_UNAWARE;
import com.android.prison.utils.Logger;


public class PackageManagerService extends IPPackageManagerService.Stub implements ISystemService {
...
//                    continue;
    ...
    public List<InstalledPackage> getInstalledPackagesAsUser(int userId) {
        ...
        synchronized (mPackages) {
            ...
            for (PPackageSettings ps : mPackages.values()) {
                if (ps.getInstalled(userId) && !GmsManager.isGoogleAppOrService(ps.pkg.packageName)) {
    ...
    public List<PPackageSettings> getPPackageSettings() {
