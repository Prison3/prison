 ...
 */
public class PResourcesManager implements IInjector {
    private static final String TAG = PResourcesManager.class.getSimpleName();
    ...
    private static Object getPackageManager() {
        try {
            Class<?> prisonCoreClass = Class.forName("com.android.prison.core.PrisonCore");
