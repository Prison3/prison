...
import com.android.prison.system.pm.IPPackageManagerService;
...
import com.android.prison.utils.TransactionThrottler;

public class PPackageManager extends Manager<IPPackageManagerService> {
    private static final PPackageManager sPackageManager = new PPackageManager();
    ...
    public static PPackageManager get() {
    ...
    public String[] getPackagesForUid(int uid) {
        try {
            return getService().getPackagesForUid(uid, PActivityThread.getUserId());
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return new String[]{};
