...
import com.android.prison.interfaces.android.app.job.BRIJobSchedulerStub;
import com.android.prison.interfaces.android.os.BRServiceManager;
import com.android.prison.manager.PJobManager;
...
import com.android.prison.utils.UIDSpoofingHelper;
...
public class IJobServiceProxy extends BinderInvocationStub {
    ...
    public static class Schedule extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    JobInfo proxyJobInfo = PJobManager.get().schedule(jobInfo);
    ...
    public static class Cancel extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                args[0] = PJobManager.get()
                        .cancel(PActivityThread.getAppConfig().processName, jobId);
                return method.invoke(who, args);
            } catch (Exception e) {
    ...
    public static class CancelAll extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                PJobManager.get().cancelAll(PActivityThread.getAppConfig().processName);
                return method.invoke(who, args);
            } catch (Exception e) {
